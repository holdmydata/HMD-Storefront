            ...
            <div className="flex pt-1 items-center sm:min-w-full">
                ...
                <div className={`w-full flex-grow`}>
                    ...
                    <div className=" z-automx-auto max-w-full py-2 bg-none rounded m-4 sm:px-4 lg:px-8">
                        <h2 className="text-md text-left flex flex-auto  font-stock uppercase font-extrabold sm:text-md ">Visits L7D</h2>
                        <div className="w-full h-full py-10">
                            <FrontpageChart/>
                        </div>
                        <h2 className="text-md text-left flex flex-auto  font-stock uppercase font-extrabold sm:text-md pb-2">Check In Customer</h2>
