...
const currentPage = location.pathname;
    ...
    <Link className={`text-lg font-inter py-3 block`}to="/dashboard"> 
        ...
        <Link className={`text-lg font-inter py-3 block ${currentPage === '/' ? 'text-pink-500 hover:text-pink-600 font-bold' : 'text-blueGray-700 hover:text-blueGray-500 font-thin'}`}to="/settings"> 
